...
module.exports["AVIF.ANAM"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["AVIF.AVFL"] = (data) => {
  return generic.print_as_hash(data);
}

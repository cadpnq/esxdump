...
module.exports["CSTY.CSCR"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["CSTY.CSCV"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["CSTY.CSFL"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["CSTY.CSGD"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["CSTY.CSLR"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["CSTY.CSME"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["CSTY.CSRA"] = (data) => {
  return generic.print_as_hash(data);
}

...
exports["SNDR.ANAM"] = generic.print_as_hash;
...
exports["SNDR.BNAM"] = generic.print_as_hash;
...
exports["SNDR.CNAM"] = generic.print_as_hash;
...
exports["SNDR.CTDA"] = generic.print_as_hash;
...
exports["SNDR.DNAM"] = generic.print_as_hash;
...
exports["SNDR.EDID"] = generic.print_as_hash;
...
exports["SNDR.FNAM"] = generic.print_as_hash;

// this field is potentially common among the following records: CLMT, CMPO, COLL, IDLE, INFO, LTEX, QUST, RACE, SNDR, WATR, WTHR, ZOOM
exports["SNDR.GNAM"] = generic.print_as_hash;

// this field is potentially common among the following records: COBJ, COLL, INFO, NOCM, SNDR, TES4
exports["SNDR.INTV"] = generic.print_as_hash;

exports["SNDR.ITMC"] = generic.print_as_hash;

exports["SNDR.ITME"] = generic.print_as_hash;

exports["SNDR.ITMS"] = generic.print_as_hash;
...
exports["SNDR.LNAM"] = generic.print_as_hash;
...
exports["SNDR.ONAM"] = generic.print_as_hash;
...
exports["SNDR.SNAM"] = generic.print_as_hash;

...
module.exports["LENS.FNAM"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["LENS.LFSD"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["LENS.LFSP"] = (data) => {
  return generic.print_as_hash(data);
}

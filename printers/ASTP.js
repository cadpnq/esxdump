...
module.exports["ASTP.EDID"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["ASTP.FCHT"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["ASTP.FPRT"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["ASTP.MCHT"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["ASTP.MPRT"] = (data) => {
  return generic.print_as_hash(data);
}

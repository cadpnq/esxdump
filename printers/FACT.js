...
exports["FACT.CITC"] = generic.print_as_hash;

exports["FACT.CRGR"] = generic.print_as_hash;

exports["FACT.CRVA"] = generic.print_as_hash;
...
exports["FACT.CTDA"] = generic.print_as_hash;
...
exports["FACT.FULL"] = generic.print_as_hash;

exports["FACT.PLVD"] = generic.print_as_hash;
...
exports["FACT.RNAM"] = generic.print_as_hash;

// this field is potentially common among the following records: FACT, SCEN
exports["FACT.VENC"] = generic.print_as_hash;

exports["FACT.VEND"] = generic.print_as_hash;

exports["FACT.VENV"] = generic.print_as_hash;

// this field is potentially common among the following records: FACT, IMAD, PACK, QUST, SCCO, SCEN, SMBN, SMEN, SMQN, WATR
exports["FACT.XNAM"] = generic.print_as_hash;

...
exports["ARTO.DNAM"] = generic.print_as_hash;
...
exports["ARTO.EDID"] = generic.print_as_hash;
...
exports["ARTO.KSIZ"] = generic.print_as_hash;

// this field is potentially common among the following records: ACTI, ALCH, AMMO, ARMO, ARTO, BOOK, CONT, DOOR, FLOR, FURN, IDLM, INNR, KEYM, LCTN, LIGH, MGEF, MISC, MSTT, NPC_, QUST, RACE, SCEN, TERM, WEAP
exports["ARTO.KWDA"] = generic.print_as_hash;

// this field is potentially common among the following records: ANIO, ARTO, MSTT, STAT
exports["ARTO.MODC"] = generic.print_as_hash;
...
exports["ARTO.MODL"] = generic.print_as_hash;
...
exports["ARTO.MODS"] = generic.print_as_hash;
...
exports["ARTO.MODT"] = generic.print_as_hash;
...
exports["ARTO.OBND"] = generic.print_as_hash;
...
exports["ARTO.PTRN"] = generic.print_as_hash;

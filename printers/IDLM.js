...
exports["IDLM.EDID"] = generic.print_as_hash;

// this field is potentially common among the following records: IDLM, PACK
exports["IDLM.IDLA"] = generic.print_as_hash;

// this field is potentially common among the following records: IDLM, PACK
exports["IDLM.IDLC"] = generic.print_as_hash;

// this field is potentially common among the following records: IDLM, PACK
exports["IDLM.IDLF"] = generic.print_as_hash;

// this field is potentially common among the following records: IDLM, PACK
exports["IDLM.IDLT"] = generic.print_as_hash;
...
exports["IDLM.KSIZ"] = generic.print_as_hash;

// this field is potentially common among the following records: ACTI, ALCH, AMMO, ARMO, ARTO, BOOK, CONT, DOOR, FLOR, FURN, IDLM, INNR, KEYM, LCTN, LIGH, MGEF, MISC, MSTT, NPC_, QUST, RACE, SCEN, TERM, WEAP
exports["IDLM.KWDA"] = generic.print_as_hash;
...
exports["IDLM.MODL"] = generic.print_as_hash;
...
exports["IDLM.MODT"] = generic.print_as_hash;

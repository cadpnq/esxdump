...
module.exports["DIAL.SNAM"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["DIAL.TIFC"] = (data) => {
  return generic.print_as_hash(data);
}

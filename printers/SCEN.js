...
exports["SCEN.ACTV"] = generic.print_as_hash;

// this field is potentially common among the following records: QUST, SCEN
exports["SCEN.ALID"] = generic.print_as_hash;
...
exports["SCEN.CNAM"] = generic.print_as_hash;

exports["SCEN.CRIS"] = generic.print_as_hash;
...
exports["SCEN.CTDA"] = generic.print_as_hash;

// this field is potentially common among the following records: LGTM, SCEN, WTHR
exports["SCEN.DALC"] = generic.print_as_hash;
...
exports["SCEN.DATA"] = generic.print_as_hash;

exports["SCEN.DEMO"] = generic.print_as_hash;

exports["SCEN.DEVA"] = generic.print_as_hash;

exports["SCEN.DMAX"] = generic.print_as_hash;

exports["SCEN.DMIN"] = generic.print_as_hash;
...
exports["SCEN.FNAM"] = generic.print_as_hash;

// this field is potentially common among the following records: HDPT, IMGS, LTEX, MATT, RACE, SCEN, SMQN
exports["SCEN.HNAM"] = generic.print_as_hash;

exports["SCEN.HTID"] = generic.print_as_hash;

// this field is potentially common among the following records: BOOK, BPTD, INFO, MESG, MOVT, NPC_, OTFT, PACK, REFR, SCEN, WATR, WEAP
exports["SCEN.INAM"] = generic.print_as_hash;

exports["SCEN.INTT"] = generic.print_as_hash;

exports["SCEN.JOUT"] = generic.print_as_hash;
...
exports["SCEN.KSIZ"] = generic.print_as_hash;

// this field is potentially common among the following records: ACTI, ALCH, AMMO, ARMO, ARTO, BOOK, CONT, DOOR, FLOR, FURN, IDLM, INNR, KEYM, LCTN, LIGH, MGEF, MISC, MSTT, NPC_, QUST, RACE, SCEN, TERM, WEAP
exports["SCEN.KWDA"] = generic.print_as_hash;

// this field is potentially common among the following records: LCTN, SCEN
exports["SCEN.LCEP"] = generic.print_as_hash;
...
exports["SCEN.LNAM"] = generic.print_as_hash;

// this field is potentially common among the following records: ARMA, AVIF, FURN, HDPT, INFO, LIGH, RACE, SCEN, TERM, WATR, WRLD, WTHR
exports["SCEN.NAM0"] = generic.print_as_hash;

exports["SCEN.NETO"] = generic.print_as_hash;

// this field is potentially common among the following records: QUST, SCEN
exports["SCEN.NEXT"] = generic.print_as_hash;

// this field is potentially common among the following records: KYWD, LSCR, MESG, PERK, QUST, RACE, RFGP, SCEN, SMQN, WEAP, WTHR
exports["SCEN.NNAM"] = generic.print_as_hash;

exports["SCEN.NNGT"] = generic.print_as_hash;

exports["SCEN.NNUT"] = generic.print_as_hash;

exports["SCEN.NPOS"] = generic.print_as_hash;

exports["SCEN.NPOT"] = generic.print_as_hash;

exports["SCEN.NQUS"] = generic.print_as_hash;

exports["SCEN.NQUT"] = generic.print_as_hash;

// this field is potentially common among the following records: RACE, SCEN
exports["SCEN.NTOP"] = generic.print_as_hash;
...
exports["SCEN.ONAM"] = generic.print_as_hash;
...
exports["SCEN.PNAM"] = generic.print_as_hash;

// this field is potentially common among the following records: RACE, SCEN
exports["SCEN.PTOP"] = generic.print_as_hash;

exports["SCEN.QTOP"] = generic.print_as_hash;

exports["SCEN.SCQS"] = generic.print_as_hash;
...
exports["SCEN.SNAM"] = generic.print_as_hash;

exports["SCEN.SSPN"] = generic.print_as_hash;

exports["SCEN.STSC"] = generic.print_as_hash;
...
exports["SCEN.TNAM"] = generic.print_as_hash;

// this field is potentially common among the following records: FACT, SCEN
exports["SCEN.VENC"] = generic.print_as_hash;
...
exports["SCEN.VMAD"] = generic.print_as_hash;

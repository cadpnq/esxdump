...
exports["PERK.CIS1"] = generic.print_as_hash;
...
exports["PERK.CTDA"] = generic.print_as_hash;
...
exports["PERK.DATA"] = generic.print_as_hash;
...
exports["PERK.DESC"] = generic.print_as_hash;

// this field is potentially common among the following records: AACT, ACHR, ACTI, ADDN, AECH, ALCH, AMDL, AMMO, ANIO, AORU, ARMA, ARMO, ARTO, ASPC, ASTP, AVIF, BNDS, BOOK, BPTD, CAMS, CELL, CLAS, CLFM, CLMT, CMPO, COBJ, COLL, CONT, CPTH, CSTY, DEBR, DFOB, DIAL, DLBR, DLVW, DMGT, DOOR, ECZN, EFSH, ENCH, EQUP, EXPL, FACT, FLOR, FLST, FSTP, FSTS, FURN, GDRY, GLOB, GMST, GRAS, HAZD, HDPT, IDLE, IDLM, IMAD, IMGS, INFO, INGR, INNR, IPCT, IPDS, KEYM, KSSM, KYWD, LAYR, LCRT, LCTN, LENS, LGTM, LIGH, LSCR, LTEX, LVLI, LVLN, MATO, MATT, MESG, MGEF, MISC, MOVT, MSTT, MSWP, MUSC, MUST, NOTE, NPC_, OMOD, OTFT, PACK, PERK, PHZD, PKIN, PROJ, QUST, RACE, REFR, REGN, RELA, REVB, RFCT, SCCO, SCEN, SCOL, SCSN, SMBN, SMEN, SMQN, SNCT, SNDR, SOPM, SOUN, SPEL, SPGD, STAG, STAT, TACT, TERM, TREE, TRNS, TXST, VTYP, WATR, WEAP, WRLD, WTHR, ZOOM
exports["PERK.EDID"] = generic.print_as_hash;

exports["PERK.EPF2"] = generic.print_as_hash;

exports["PERK.EPF3"] = generic.print_as_hash;

exports["PERK.EPFB"] = generic.print_as_hash;

exports["PERK.EPFD"] = generic.print_as_hash;

exports["PERK.EPFT"] = generic.print_as_hash;
...
exports["PERK.FNAM"] = generic.print_as_hash;
...
exports["PERK.FULL"] = generic.print_as_hash;

// this field is potentially common among the following records: KYWD, LSCR, MESG, PERK, QUST, RACE, RFGP, SCEN, SMQN, WEAP, WTHR
exports["PERK.NNAM"] = generic.print_as_hash;

exports["PERK.PRKC"] = generic.print_as_hash;

exports["PERK.PRKE"] = generic.print_as_hash;

exports["PERK.PRKF"] = generic.print_as_hash;
...
exports["PERK.SNAM"] = generic.print_as_hash;
...
exports["PERK.VMAD"] = generic.print_as_hash;

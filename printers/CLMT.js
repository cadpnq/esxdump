...
module.exports["CLMT.TNAM"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["CLMT.WLST"] = (data) => {
  return generic.print_as_hash(data);
}

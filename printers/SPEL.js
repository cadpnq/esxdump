...
module.exports["SPEL.OBND"] = (data) => {
  return generic.print_as_hash(data);
}

module.exports["SPEL.SPIT"] = (data) => {
  return generic.print_as_hash(data);
}

...
module.exports["LVLN.EDID"] = (data) => {
  return generic.print_as_hash(data);
}

// this field is potentially common among the following records: LVLI, LVLN
module.exports["LVLN.LLCT"] = (data) => {
  return generic.print_as_hash(data);
}

// this field is potentially common among the following records: LVLI, LVLN
module.exports["LVLN.LLKC"] = (data) => {
  return generic.print_as_hash(data);
}

// this field is potentially common among the following records: LVLI, LVLN
module.exports["LVLN.LVLD"] = (data) => {
  return generic.print_as_hash(data);
}

// this field is potentially common among the following records: LVLI, LVLN
module.exports["LVLN.LVLF"] = (data) => {
  return generic.print_as_hash(data);
}

// this field is potentially common among the following records: LVLI, LVLN
module.exports["LVLN.LVLG"] = (data) => {
  return generic.print_as_hash(data);
}

// this field is potentially common among the following records: LVLI, LVLN
module.exports["LVLN.LVLM"] = (data) => {
  return generic.print_as_hash(data);
}

// this field is potentially common among the following records: LVLI, LVLN
module.exports["LVLN.LVLO"] = (data) => {
  return generic.print_as_hash(data);
}
